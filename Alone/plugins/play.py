...
from Alone import call_py, Alone, client as Client
owner = "6079943111"
from Alone.helpers.yt_dlp import bash
from Alone.helpers.chattitle import CHAT_TITLE
from Alone.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from Alone.helpers.thumbnail import gen_thumb
from Alone.helpers.joiner import AssistantAdd
...
@Alone.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
...
#play
@Alone.on(events.NewMessage(pattern="^[.?!/]play"))
@AssistantAdd
...
@Alone.on(events.NewMessage(pattern="^[./?!]end"))
@is_admin
...
@Alone.on(events.NewMessage(pattern="^[.?!/]vplay"))
@AssistantAdd
...
#playlist
@Alone.on(events.NewMessage(pattern="^[.?!/]playlist"))
@is_admin
...
#leavevc
@Alone.on(events.NewMessage(pattern="^[.?!/]leavevc"))
@is_admin
...
@Alone.on(events.NewMessage(pattern="^[.?!/]skip"))
@is_admin
...
@Alone.on(events.NewMessage(pattern="^[.?!/]pause"))
@is_admin
...
@Alone.on(events.NewMessage(pattern="^[.?!/]resume"))
@is_admin
